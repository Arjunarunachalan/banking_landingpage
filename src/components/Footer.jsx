    ...
    flex-col`}>
     ...
     w-full`}>
        ...
        mr-10">
          ...
          `}>A new Way to make the payments easy,raliable and secure 
        ...
        justify-between flex-wrap md:mt-0 mt-10">
              {footerLinks.map((footerlink)=>(
                ...
                flex flex-col ss:my-0 my-4 min-w-[150px]">
                    ...
                    leading-[27px] text-white mb-2">
                      {footerlink.title}
                    </h4>
                    <ul className="list-none">
                      {footerlink.links.map((link,index)=>(
                        <li key={link.name} className={`font-poppins text-[16px]
     ...
     md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3F3E45]  ">
      <p className="font-poppins font-normal text-center  text-[18px]
                    leading-[27px] text-white mb-2">2021 HooBank. All Rights Reserved</p>
