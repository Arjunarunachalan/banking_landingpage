...
const Billing = () =>(
  <section id='products' className={layout.sectionReverse}>
    <div className={layout.sectionImgReverse}>
      ...
      h-[100%] relative z-[5]' />
    {/* white shade gradient on the left side  */}
    ...
    <div className={layout.sectionInfo}>
     <h2 className={styles.heading2}>
      Easly Control Your <br className='sm:block hidden'/>  billing & Invoicing .
     </h2>
     <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
      Elite enim sed massa etiam. mauris eu adipisicing ultrices ametodio
